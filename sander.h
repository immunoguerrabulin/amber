...
typedef struct {
    ...
    int gbsa;
    int lj1264;
    int fires;// Roux Guerra 
    double mts_fires; // JOSE MOD: FIRES small timestep (ps)
    int mts_n; // JOSE MOD: FIRES microstep count per outer step
    int plj1264; // New2021
    int ipb;
    int inp;
    int vdwmeth;
