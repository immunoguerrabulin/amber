...
do i=1,natom
   ...
   if (ineighbor(count) == 0) then
      ...
      do jjj = 1, num_j_vals
         ...
         sumdajkddjkdyj=0.d0
         sumdajkddjkdzj=0.d0
         p3p4aij = -1*(p3(i) + p4(i)*aij)*frespa
...
!!!         !dir$ ivdep
         ...
         daidxj=(p2(i)*daijddijdxj &
               +p3(i)*sumdajkddjkdxj+p4(i)*lastxj)
         daidyj=(p2(i)*daijddijdyj &
               +p3(i)*sumdajkddjkdyj+p4(i)*lastyj)
         daidzj=(p2(i)*daijddijdzj &
      ...
      daidxi = (p2(i)*sumdaijddijdxi &
            +p4(i)*sumdaijddijdxiajk)
      daidyi = (p2(i)*sumdaijddijdyi &
            +p4(i)*sumdaijddijdyiajk)
      daidzi = (p2(i)*sumdaijddijdzi &
