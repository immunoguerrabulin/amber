...
! New allocatable arrays, using pointers as a transitional form:
   ...
   integer, dimension(:), pointer :: &
      ...
      belly_group, atom_noshake, num_bonds, nmr_iwork, atomicnumber
...
#include "dynph.h"
  ...
  ! FIXME: n12, m14, m16   DEAD but still allocated??
      ...
      atomicnumber => ix(i100+1:i100+natom)
...
!!
      ...
      belly_group => ix(ibellygp:ibellygp+natom-1) ! RL: ibelly is the flag
