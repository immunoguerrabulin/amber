...
!  New2021
   if (plj1264 == 1) then
      cn7(1:3*C4Pairwise) = parmdata%lennard_jones_dcoef(1:3*C4Pairwise)
      cn8(1:C4Pairwise) = parmdata%lennard_jones_dvalue(1:C4Pairwise)
   else
      cn7(1:3*C4Pairwise) = 0
      cn8(1:C4Pairwise) = 0.d0
   end if
   if (vdwmodel == 1) then
