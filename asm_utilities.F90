...
contains
	...
	subroutine read_string(file, string)
		...
		_REAL_, dimension(:,:), intent(out) :: string
...
#include "../include/dprec.fh"
		...
		_REAL_, dimension(:), intent(out) :: Minv
		
		_REAL_, dimension(:,:), allocatable :: Mtmp
...
#include "parallel.h"
		...
		tmpfile = "string_utilities_lines_tmp_file"//trim(adjustl(tmpfile))
