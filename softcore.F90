...
#include "parallel.h"
  ...
  integer,save :: ijarzynski
  integer,save :: jarzynski_cnt
  _REAL_,save :: jarzynski_work
  _REAL_,save :: jarzynski_lambda_min, jarzynski_lambda_max
...
!===================================================================================================
#ifdef MPI
    subroutine update_jarzynski_work(ener)
      use state
      type(state_rec) :: ener
      _REAL_ :: val

      jarzynski_cnt = jarzynski_cnt + 1
      ! update the average
      val = (jarzynski_lambda_max-jarzynski_lambda_min) * ener%pot%dvdl
      jarzynski_work = jarzynski_work + (val-jarzynski_work)/jarzynski_cnt
    end subroutine update_jarzynski_work
#endif

!===================================================================================================
    subroutine reset_jarzynski_work()
      jarzynski_cnt  = 0
      jarzynski_work = 0.d0
    end subroutine reset_jarzynski_work
