...
subroutine allocate_int_decomp( natom )
...
subroutine decsasa_sbpl(ntype,nat1,nat2,nat3, &
   ...
   integer, intent(inout) :: nres1, nres2, nres3
   logical, intent(out)   :: isside1, isside2, isside3
   logical, intent(out)   :: isprot1, isprot2, isprot3
...
#  include "../include/memory.h"
#  include "../include/md.h" /* need dec_verbose, JMS 11/2010 */
   ...
   355 format(7('==========='))
   360 format('TDC',1x,i7,'->',i7,5(1x,f12.6))
   362 format('SDC',1x,i7,'->',i7,5(1x,f12.6))
   364 format('BDC',1x,i7,'->',i7,5(1x,f12.6))
