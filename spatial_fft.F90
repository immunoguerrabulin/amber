...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
integer function location(           k_inf, k, &
                           j_length, j_inf, j, &
                           i_length, i_inf, i )
  !
...
#  include "parallel.h"
  ...
  do k = pre_inf, pre_sup
     do j = alt_inf, alt_sup
        ...
        index = location( pre_inf, k, alt_len, alt_inf, j, &
              con_len, con_inf, 0 )
...
#  include "parallel.h"
  ...
  do i = pre_inf, pre_sup
     do k = alt_inf, alt_sup
        ...
        index = location( pre_inf, i, alt_len, alt_inf, k, &
              con_len, con_inf, 0 )
...
#  include "parallel.h"
  ...
  do j = alt_inf, alt_sup
     do i = pre_inf, pre_sup
        ...
        index = location( alt_inf, j, pre_len, pre_inf, i, &
              con_len, con_inf, 0 )
