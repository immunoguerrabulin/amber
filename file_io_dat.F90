...
character(len=MAX_FN_LEN), save :: cein      ! Constant Redox potential input file
character(len=MAX_FN_LEN), save :: ceout     ! Constant Redox potential output file
character(len=MAX_FN_LEN), save :: cerestrt  ! Constant Redox potential restart file
character(len=MAX_FN_LEN), save :: cpein     ! Constant pH and Redox potential input file
character(len=MAX_FN_LEN), save :: cpeout    ! Constant pH and Redox potential output file
character(len=MAX_FN_LEN), save :: cperestrt ! Constant pH and Redox potential restart file
...
integer, parameter :: CNSTE_UNIT = 20
integer, parameter :: CEOUT_UNIT = 22
integer, parameter :: CE_DUMP_UNIT = 23
...
logical, save :: write_dump_ph = .false.
! Public for pH REM
_REAL_, save  :: target_ph
logical, save :: on_cestep = .false.
logical, save :: write_dump_e = .false.
! Public for Redox potential REM
_REAL_, save  :: target_e
